...
${cde} keys:remove ${sshKeyId} 2>&1 | watchError | report "keys:add"
# ${cde} keys:add ${sshFilePath}
git remote remove cde
${cde} apps:create ${appName} javajersey-test 2>&1 | watchError | report "apps:create"
