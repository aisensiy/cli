...
type FakeAppRepository struct {
	...
	UpdateStub        func(id string, params api.AppParams) (updatedApp api.App, apiErr error)
	...
	SetEnvStub        func(app api.App, kv api.KeyValue) error
	...
	UnsetEnvStub        func(app api.App, key string) error
...
func (fake *FakeAppRepository) Update(id string, params api.AppParams) (updatedApp api.App, apiErr error) {
...
func (fake *FakeAppRepository) UpdateCallCount() int {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
	return len(fake.updateArgsForCall)
}

func (fake *FakeAppRepository) UpdateArgsForCall(i int) (string, api.AppParams) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
	return fake.updateArgsForCall[i].id, fake.updateArgsForCall[i].params
}

func (fake *FakeAppRepository) UpdateReturns(result1 api.App, result2 error) {
	fake.UpdateStub = nil
...
func (fake *FakeAppRepository) SetEnv(app api.App, kv api.KeyValue) error {
...
func (fake *FakeAppRepository) SetEnvArgsForCall(i int) (api.App, api.KeyValue) {
	fake.setEnvMutex.RLock()
	defer fake.setEnvMutex.RUnlock()
	return fake.setEnvArgsForCall[i].app, fake.setEnvArgsForCall[i].kv
}
...
func (fake *FakeAppRepository) UnsetEnv(app api.App, key string) error {
	...
	if fake.UnsetEnvStub != nil {
		return fake.UnsetEnvStub(app, key)
	} else {
...
func (fake *FakeAppRepository) UnsetEnvArgsForCall(i int) (api.App, string) {
	fake.unsetEnvMutex.RLock()
	defer fake.unsetEnvMutex.RUnlock()
	return fake.unsetEnvArgsForCall[i].app, fake.unsetEnvArgsForCall[i].key
}
